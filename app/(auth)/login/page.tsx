      ...
      <div className="bg-white rounded-3xl shadow-card p-12 max-w-[500px] w-full text-center">
        ...
        <div className="space-y-3">
          ...
          <Link
            ...
            className="w-full bg-[#1877F2] border-2 border-[#1877F2] text-white px-8 py-4 rounded-full font-nunito font-extrabold text-lg hover:bg-[#0C63D4] hover:-translate-y-0.5 transition-all flex items-center justify-center gap-3 no-underline"
          >
